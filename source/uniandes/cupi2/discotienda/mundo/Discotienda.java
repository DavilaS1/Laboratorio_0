...
public class Discotienda
{
    ...
    public void darDiscosCostosos(String uGenero) throws FileNotFoundException, IOException
    {
    	int evaluarDiscosCostosos = 0;
    	int evaluarGenero= 0;
    	...
    	for (int i = 0; i<discos.size(); i++) 
    	{
    		...
    		{
    			evaluarGenero++;
    	    // Evaluacion si el disco supera el precio de 1000
    			if (miDisco.darPrecioDisco()>1000) 
    			{
    				evaluarDiscosCostosos++;
    			}
    		}
    	}
    	if (evaluarGenero==0)
    	{
    		throw new IOException("El genero especificado no se encontro" + uGenero);
    	}
    	else if (evaluarDiscosCostosos==0)
    	{
    		throw new IOException("En el genero seleccionado, no existen discos costosos " + uGenero);
    	}
    	...
    	for (int i = 0; i<discos.size(); i++) 
    	{
    		...
    		if (varDisco.darGenero().equals(uGenero)) 
    		{
